...
"[project]/apps/web/src/features/auth/authSlice.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const authSlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSlice"])({
    ...
    reducers: {
        setAuthSession (state, action) {
            ...
            state.error = null;
            if (state.user && ("TURBOPACK compile-time value", "object") !== 'undefined') {
                const storedOrgId = localStorage.getItem('activeOrgId');
                if (storedOrgId) {
                    const isMember = state.user.organizations?.some((org)=>org.organization_id === storedOrgId);
                    if (isMember) {
                        state.user.organization_id = storedOrgId;
                        const selectedOrg = state.user.organizations?.find((org)=>org.organization_id === storedOrgId);
                        if (selectedOrg) {
...
"[project]/apps/web/src/store/rootReducer.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const rootReducer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$redux$2f$dist$2f$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["combineReducers"])({
    auth: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$features$2f$auth$2f$authSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
});
...
"[project]/apps/web/src/store/store.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$store$2f$rootReducer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/store/rootReducer.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
;
;
;
const store = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["configureStore"])({
    reducer: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$store$2f$rootReducer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"],
...
function ReduxProvider({ children }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Provider"], {
        store: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$store$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["store"],
        children: children
    }, void 0, false, {
...
"[project]/apps/web/src/lib/api/queryClient.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/src/components/providers/ReactQueryProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$api$2f$queryClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/api/queryClient.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function ReactQueryProvider({ children }) {
    ...
    const [queryClient] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "ReactQueryProvider.useState": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$api$2f$queryClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getQueryClient"])()
...
_s(ReactQueryProvider, "xWzZ3DtKXbYlVX/K0rEF3F2kgkk=");
...
"[project]/apps/web/src/components/common/AppGlobalLoader.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AppGlobalLoader() {
    _s();
    const isInitialized = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$store$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "AppGlobalLoader.useAppSelector[isInitialized]": (state)=>state.auth.isInitialized
    }["AppGlobalLoader.useAppSelector[isInitialized]"]);
        ...
        "AppGlobalLoader.useEffect": ()=>{
            if (isInitialized) {
                const timer = setTimeout({
                    "AppGlobalLoader.useEffect.timer": ()=>setShowLoader(false)
                }["AppGlobalLoader.useEffect.timer"], 800);
                return ({
                    "AppGlobalLoader.useEffect": ()=>clearTimeout(timer)
                })["AppGlobalLoader.useEffect"];
            } else {
                setShowLoader(true);
            }
...
_s(AppGlobalLoader, "868Tr1aMNEFbT6k6uylk6xn9ZhQ=", false, function() {
    return [
...
_c = AppGlobalLoader;
var _c;
__turbopack_context__.k.register(_c, "AppGlobalLoader");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=apps_web_src_be338b36._.js.map